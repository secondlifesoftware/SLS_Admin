...
function IdeasList() {
  ...
  return (
    <div className="min-h-screen">
      {/* Header */}
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-white mb-2">Ideas</h1>
        <p className="text-gray-400">Projects in development and coming soon</p>
      </div>
      ...
      <div className="mb-8">
        <div className="relative">
          <input
            ...
            className="w-full px-4 py-3 bg-[#1f1f1f] border border-gray-700 rounded-xl text-white placeholder-gray-500 focus:outline-none focus:border-cyan-500/50 focus:ring-2 focus:ring-cyan-500/20 transition-all duration-200"
          />
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-gradient-to-br from-cyan-500/20 to-blue-600/20 border border-cyan-500/30 rounded-xl p-6 border-cyan-500/30 hover:border-cyan-500/50 transition-all duration-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-gray-400 text-sm font-medium mb-1">Coming Soon</p>
              <p className="text-3xl font-bold text-cyan-400">{comingSoonIdeas.length}</p>
            </div>
            <div className="text-4xl">⏳</div>
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {inProgressIdeas.map((idea) => (
                <div
                  ...
                  className="bg-[#1f1f1f] border border-gray-700 rounded-xl p-6 cursor-pointer hover:border-cyan-500/50 hover:bg-[#252525] transition-all duration-200 group"
                >
